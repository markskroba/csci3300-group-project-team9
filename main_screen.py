...
question_body_column = [ 
            ...
            [sg.Text("Q: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua?", size=(30,6))],
            [sg.Text("A: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", size=(30,6))]
]
...
while True:
    ...
    if event == sg.WIN_CLOSED or event == 'Cancel':
        break
    if event != 'Search' and event != 'Add a question':
